...
// Verto's current product target is resizable desktop windows (1024px+).
// Keep the historical phone checks visible but outside the desktop release gate.
test.describe.skip("390px mobile", () => {
