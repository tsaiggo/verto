...
[Navigation → Sorting order](/read/docs/core-concepts/navigation) for the full
comparison rules, and [navigation.json](/read/docs/reference/navigation-json)
...
- [Navigation](/read/docs/core-concepts/navigation) — how the tree, sorting, and sidebar are built
- [navigation.json](/read/docs/reference/navigation-json) — override `title` / `order` / `hidden` without touching frontmatter
- [MDX Authoring](/read/docs/writing/mdx-authoring) — the full guide to writing document bodies
