...
[Navigation](/read/docs/core-concepts/navigation)); `navigation.json` is a thin
...
- [Navigation](/read/docs/core-concepts/navigation) — the file-system model these overrides sit on top of
- [Frontmatter](/read/docs/reference/frontmatter) — set `title` / `order` / `hidden` per file instead
- [Environment Variables](/read/docs/reference/environment-variables) — where the source root (and thus this file) lives for remote sources
