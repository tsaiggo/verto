...
<CardGroup cols={2}>
  <Card title="快速开始" description="60 秒跑起一个 Verto" href="/read/docs/getting-started/installation" />
  <Card title="行内评论" description="用 [^c-1] 在正文里加入弹窗式注解" href="/read/docs/core-concepts/inline-comments" />
  <Card title="语法高亮" description="Shiki + 双主题 + diff / focus / word" href="/read/docs/writing/syntax-highlighting" />
  <Card title="深色模式" description="基于 CSS 变量，切换零闪烁" href="/read/docs/reading-experience/dark-mode" />
</CardGroup>
...
sequenceDiagram
  ...
  R->>V: GET /read/docs/showcase/verto-quan-jia-tong-yan-shi
  V->>FS: 读取 .mdx
  FS-->>V: 源文件
  V-->>R: 渲染好的 HTML
`} />
