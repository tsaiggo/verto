...
Install Verto using your preferred package manager:

<PackageInstall name="verto" />

Or install dependencies for a cloned checkout:
...
- Learn about [Inline Comments](/read/docs/core-concepts/inline-comments) — Verto's most distinctive authoring feature
- Explore [Block Components](/read/docs/writing/block-components) like Callouts, Toggles, and Bookmark Cards
- Check out [Dark Mode](/read/docs/reading-experience/dark-mode) and the other feature pages to learn about everything Verto offers
