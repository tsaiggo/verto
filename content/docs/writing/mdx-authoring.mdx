...
For the complete list of fields, their effects, and the fallbacks Verto applies when they're omitted, see the [Frontmatter Reference](/read/docs/reference/frontmatter). Blog posts add a few extra fields (`date`, `author`, `tags`) covered in [Blog System](/read/docs/reading-experience/blog).
...
See [Block Components](/read/docs/writing/block-components) for the full catalog of available components.
...
- [Frontmatter Reference](/read/docs/reference/frontmatter) — every frontmatter field and its fallback
- [Block Components](/read/docs/writing/block-components) — the full component catalog
- [Inline Comments](/read/docs/core-concepts/inline-comments) — author asides with `[^c-N]`
- [Blog System](/read/docs/reading-experience/blog) — blog-specific frontmatter and layout
