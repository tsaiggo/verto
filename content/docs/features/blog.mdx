...
- [MDX Authoring](/docs/features/mdx-authoring) covers the MDX syntax and features available in blog posts
- [Block Components](/docs/features/block-components) documents the components you can use inside blog content
