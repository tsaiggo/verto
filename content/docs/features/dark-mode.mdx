...
- [Syntax Highlighting](/docs/features/syntax-highlighting) covers how Shiki renders dual-theme code blocks using these same CSS variables
- [Block Components](/docs/features/block-components) documents the MDX components that automatically adapt to the active theme
