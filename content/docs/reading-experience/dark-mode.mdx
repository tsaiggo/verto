...
- [Syntax Highlighting](/read/docs/writing/syntax-highlighting) covers how Shiki renders dual-theme code blocks using these same CSS variables
- [Block Components](/read/docs/writing/block-components) documents the MDX components that automatically adapt to the active theme
