...
<CardGroup cols={2}>
  ...
  <Card title="语法高亮" description="Shiki + 双主题 + diff / focus / word" href="/read/docs/features/syntax-highlighting" />
  <Card title="深色模式" description="基于 CSS 变量，切换零闪烁" href="/read/docs/features/dark-mode" />
</CardGroup>
...
sequenceDiagram
  ...
  R->>V: GET /read/blog/verto-quan-jia-tong-yan-shi
  V->>FS: 读取 .mdx
  FS-->>V: 源文件
  V-->>R: 渲染好的 HTML
`} />
