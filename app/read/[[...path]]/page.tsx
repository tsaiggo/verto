    ...
    return (
      <>
        <aside className="sidebar reader-sample-sidebar" aria-label="Sources and document tree">
          ...
          <div className="reader-sample-side-search">
            <Search aria-hidden />
            <span>Search</span>
            <span className="reader-sample-side-kbd">⌘K</span>
          </div>
          ...
          <div className="reader-sample-tree">
            {[
              ...
              <div
                key={label}
                className={`reader-sample-source${index === 0 ? " is-active" : ""}`}
              >
        ...
        <section className="main" aria-label="Document content">
          ...
          <article className="content-wrap prose reader-sample-article" lang="en" data-article>
            ...
            <p>
              The Annotation System enables readers to highlight, comment, and connect ideas
              directly in the flow of reading. Annotations are{" "}
              <mark className="reader-sample-highlight">anchored to exact text ranges</mark>,
              persist across edits, and surface in the right context.
            </p>
            ...
            <div className="reader-sample-callout is-green">
              ...
              <div>
                <strong>Tip</strong>
                <p>
                  Use short, descriptive notes. Future you and your team should understand the
        ...
        <aside className="toc-rail reader-sample-context" aria-label="Document context">
          <div className="rail-panel toc-panel">
            <div className="reader-sample-context-tabs">
              ...
              <span>Notes <strong>6</strong></span>
              <span>Backlinks <strong>12</strong></span>
              <span>Assistant</span>
            </div>
              ...
              <div className="reader-note-list">
                {[
                  ...
                  <article key={note.quote} className="reader-note-card">
                    ...
                    <p>{note.body}</p>
                    <span className="reader-note-tag">data model</span>
                  </article>
                ))}
