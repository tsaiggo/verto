...
- [Block Components](/help/writing/block-components) — including the
  layout-only `DiagramPlaceholder` for deliberately omitted diagrams; working
  diagrams should use one of the three renderers above
- [MDX Authoring](/help/writing/mdx-authoring) for the full MDX writing guide
- [Syntax Highlighting](/help/writing/syntax-highlighting) for how fenced
