...
For the complete list of fields, their effects, and the fallbacks Verto applies when they're omitted, see the [Frontmatter Reference](/help/reference/frontmatter). Blog posts add a few extra fields (`date`, `author`, `tags`) covered in [Blog System](/help/reading-experience/blog).
...
- [Blog System](/help/reading-experience/blog) — blog-specific frontmatter and layout
