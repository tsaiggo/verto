...
[`navigation.json`](/help/reference/navigation-json) is read from the
...
- [Local Folder](/help/desktop-app/local-folder) — choosing a folder from the desktop UI
- [navigation.json](/help/reference/navigation-json) — where the override file lives per source
- [Static Generation](/help/reading-experience/static-generation) — why content is resolved at build time
