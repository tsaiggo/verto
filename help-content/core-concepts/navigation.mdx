...
[content source](/help/reference/environment-variables) for `.md` and
...
[Reference → navigation.json](/help/reference/navigation-json).
...
[Reference → Frontmatter](/help/reference/frontmatter).
...
- [Reference → navigation.json](/help/reference/navigation-json) — the full override schema
- [Reference → Frontmatter](/help/reference/frontmatter) — every frontmatter field and its fallback
- [Responsive Design](/help/reading-experience/responsive-design) — how the layout adapts across breakpoints
- [Inline Comments](/help/core-concepts/inline-comments) — the other core authoring concept
