...
// Keep every reference in one searchable row. The compact table is deliberate:
// each record maps directly to one product surface and does not carry behavior.
// prettier-ignore
const rows = [
  ...
  ["60_add-source-connect","Add Source - Connect","Sources & Git","Step 2","06","Local library setup and access scope."],
